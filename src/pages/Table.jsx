                        ...
                        <table className="table table-striped table-light table-bordered">
                            ...
                            <tbody>
                                {TablePage * 4 < TableData.length && <tr >
                                    ...
                                    <td className="text-center">{TableData[TablePage * 4]["Cycletime"]}</td>
                                    <td className="text-center">{TableData[TablePage * 4]["ProgramNumber"]}</td>
                                    <td className="text-center">{TableData[TablePage * 4]["Operator"]}</td>
                                    <td className="text-center">{TableData[TablePage * 4]["Shift"]}</td>
                                    <td className="d-flex">
